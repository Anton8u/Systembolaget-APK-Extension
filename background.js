      ...
      chrome.scripting.executeScript({
        ...
        function: (reorder, idToApk) => {
          ...
          if (existingApkDiv && reorder === 0) {
            console.log('APKs div already exists && Not sorting. Cancelling function.');
      ...
      chrome.scripting.executeScript({
        ...
        function: (idToApk) => {
          ...
          if (existingApkDiv) {
            ...
            const existingApkValue = parseFloat(existingApkText.replace('APK: ', ''));
            const newApkValue = apk / 100;
            
            console.log('Existing APK:', existingApkValue, 'New APK:', newApkValue);
